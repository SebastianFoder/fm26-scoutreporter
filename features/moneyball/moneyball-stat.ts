...
export enum MoneyballStat {
  ...
  /** Derived in Mustermann Mode: (Hdrs A / Minutes) * 90 — not a raw CSV column. */
  HeadersAttemptedPer90 = "Hdrs A/90",
  ...
  /** Total key passes per 90 (Mustermann export). */
  KeyPassesPer90 = "KP/90",
  ...
  /** Derived in Mustermann Mode: (Off / Minutes) * 90 — not a raw CSV column. */
  OffsidesPer90 = "Off/90",
  ...
  /** Total shots per 90 (Mustermann export). */
  ShotsPer90 = "Shot/90",
  ShotsBlockedPer90 = "Shts Blckd/90",
  SprintsPer90 = "Sprints/90",
  TacklesAttempted = "Tck A",
...
const MONEYBALL_STAT_LABELS: Record<MoneyballStat, string> = {
  ...
  [MoneyballStat.HeadersAttemptedPer90]: "Headers Attempted / 90",
  ...
  [MoneyballStat.KeyPassesPer90]: "Key Passes / 90",
  ...
  [MoneyballStat.OffsidesPer90]: "Offsides / 90",
